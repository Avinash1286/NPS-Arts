...
public class CreativeHands extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     showCreativeHands.setVisibility(View.GONE);
     ...
     publishingStatus.addValueEventListener(new ValueEventListener() {
         @Override
         public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             if (String.valueOf(dataSnapshot.child("Status").getValue()).equals("yes")){
                 loadData();
                 showCreativeHands.setVisibility(View.VISIBLE);
...
*/
                ...
                creativeViewHolder.mView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        userReff.addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.child(currentUsers).child("permission").getValue().toString().equals("yes")){
    ...
    public void onRefresh() {
        publishingStatus.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
