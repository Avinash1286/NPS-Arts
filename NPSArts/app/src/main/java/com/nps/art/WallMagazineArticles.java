...
public class WallMagazineArticles extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        publishingStatus.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (String.valueOf(dataSnapshot.child("Status").getValue()).equals("yes")){
                    ...
                    loadData();
                    showArtsofWallMagazine.setVisibility(View.VISIBLE);
                    nopublish.setVisibility(View.GONE);
                }
                else {
                    showArtsofWallMagazine.setVisibility(View.GONE);
        ...
        showArtsofWallMagazine.setLayoutManager(new GridLayoutManager(getActivity(),2));
