                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            switch (item.getItemId()){
                                case R.id.reportButton:
                                    ...
                                    fragmentTransaction1.add(R.id.showReportFragment,fragment);
                                    fragmentTransaction1.addToBackStack(null);
                                    fragment.postKeyValue=postKey;
                                    fragment.postTitle=model.getHeading();
                                    fragment.reporterName=userName;
                                    fragment.reporterProLink=userProLink;
                                    fragment.postUserName=model.getUserName();
                                    fragment.uidKey=model.getUid();
                                    fragment.postType=model.getPostType();
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    ...
                    case R.id.postprofile:
                        startActivity(new Intent(ShowPost.this,ProfileActivity.class));
                        overridePendingTransition(R.anim.comment_in,R.anim.comment_in);
                        finish();
                        break;
                }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            userReff=FirebaseDatabase.getInstance().getReference().child("Users");
             circularImageViewProfile=(CircularImageView) mView.findViewById(R.id.userProInMain);
        }
...
*/
    ...
    public void showDialogForDeletePost(){
