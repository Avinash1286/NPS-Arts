                ...
                postReff.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (shareButtonChecker.equals(true)){
                            heading=String.valueOf(dataSnapshot.child(postKey).child("heading").getValue());
                            articles=String.valueOf(dataSnapshot.child(postKey).child("articles").getValue());
        ...
        userReff.child(currentUsers).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    ...
                    currentUsername =String.valueOf(dataSnapshot.child("fullname").getValue());
                    currentProLink = String.valueOf(dataSnapshot.child("profileLink").getValue());
                }
                catch (Exception e){
                    e.printStackTrace();
