...
public class ProfileActivity extends AppCompatActivity{
    ...
    private DatabaseReference postRef, userRef,reportRef,onlineLikeRef,compConRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationViewEx=(BottomNavigationViewEx)findViewById(R.id.inOwnerProfilebottomnav);
        ...
        compConRef=FirebaseDatabase.getInstance().getReference().child("complainCon");
        ...
        final ImageView openComplain=(ImageView)view.findViewById(R.id.complainBox);
        ImageView openPending=(ImageView)view.findViewById(R.id.pendingopen);
        ImageView openAbout=(ImageView)view.findViewById(R.id.openAbout);
        ...
        compConRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
           if (String.valueOf(dataSnapshot.child("condition").getValue()).equals("yes")){
               openComplain.setVisibility(View.VISIBLE);
           }
           else {
               openComplain.setVisibility(View.GONE);
           }
            }
        ...
        openPending.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ProfileActivity.this,ShowPendingPosts.class));
            }
        });
        ...
        bottomNavigationViewEx.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    case R.id.home:
                        startActivity(new Intent(ProfileActivity.this,ShowPost.class));
                        overridePendingTransition(R.anim.comment_in,R.anim.comment_in);
                        finish();
                        break;
                    case R.id.postsearch:
                        startActivity(new Intent(ProfileActivity.this,SearchPeople.class));
                        overridePendingTransition(R.anim.comment_in,R.anim.comment_in);
                        finish();
                        break;
                    case R.id.offlineArticles:
                        ...
                        break;
                    case R.id.postlikes:
                        startActivity(new Intent(ProfileActivity.this,HeartActivity.class));
                        overridePendingTransition(R.anim.comment_in,R.anim.comment_in);
                        finish();
                        break;
