...
public class PoemVoting extends Fragment {
 ...
 private     DatabaseReference poemRef,checkRef,poemVotersOne,poemVotersAll,checkVoting,userRef;
        ...
        if (checkForConnctoin()){
            ...
            checkVoting.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    String con=String.valueOf(dataSnapshot.child("PoemStatus").getValue());
                    if (con.equals("yes")){
                        getData();
                    }
                    else {
